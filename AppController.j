...
- (void)applicationDidFinishLaunching:(CPNotification)aNotification
{
		...
		statusText = [[UpdaterView alloc] initWithFrame:CGRectMake(0, 0, 180, 32)];
		//toobar = [[CPToolbar alloc] initWithIdentifier:"Photos"];
...
- (CPToolbarItem)toolbar:(CPToolbar)aToolbar itemForItemIdentifier:(CPString)anItemIdentifier willBeInsertedIntoToolbar:(BOOL)aFlag
{
        ...
        {
                [toolbarItem setView:statusText];
...
//         label = [CPTextField flickr_labelWithText:"Loading"];
        
        [imageView setFrameOrigin:CGPointMake(0, (aFrame.height/2.0)-(([label boundsSize].height)/2.0))];
        [self addSubview:imageView];
        [label setFrameOrigin:CGPointMake(20, (aFrame.height/2.0)-(8))];
